...
pub fn known_selectors() -> &'static HashMap<String, String> {
    ...
    SELECTORS.get_or_init(|| {
        HashMap::from([
            ...
            (
                "0x7ff36ab5".into(),
                "swapExactETHForTokens(uint256,address[],address,uint256)".into(),
            ),
            (
                "0x18cbafe5".into(),
                "swapExactTokensForETH(uint256,uint256,address[],address,uint256)".into(),
            ),
            (
                "0xe8e33700".into(),
            ...
            (
                "0xf305d719".into(),
                "addLiquidityETH(address,uint256,uint256,uint256,address,uint256)".into(),
            ),
            (
                "0xbaa2abde".into(),
                "removeLiquidity(address,address,uint256,uint256,uint256,address,uint256)".into(),
            ),
            (
                "0x02751cec".into(),
                "removeLiquidityETH(address,uint256,uint256,uint256,address,uint256)".into(),
            ),
            // Uniswap V3
            ...
            (
                "0xc04b8d59".into(),
                "exactInput((bytes,address,uint256,uint256,uint256))".into(),
            ),
            (
                "0xdb3e2198".into(),
            ...
            (
                "0xf28c0498".into(),
                "exactOutput((bytes,address,uint256,uint256,uint256))".into(),
            ),
            // Common
...
pub const WETH_DEPOSIT_TOPIC: &str =
